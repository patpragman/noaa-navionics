...
def build_parser() -> argparse.ArgumentParser:
    ...
    mark.add_argument("--seconds", type=_gps_wait_seconds, default=10.0, help="seconds to wait for a GPS fix")
    ...
    mob.add_argument("--seconds", type=_gps_wait_seconds, default=10.0, help="seconds to wait for a GPS fix")
