...
READY reports also require structured Clock and Time Sync evidence, including a fresh timezone-aware clock timestamp and Raspberry Pi `SystemClockSynchronized=yes` unless the report explicitly records a non-Pi diagnostic skip.
