...
Readiness and Pi verification require a well-formed `vcgencmd get_throttled` value and fail on any current or historical under-voltage, frequency capping, throttling, or soft thermal limiting reported since boot.
