...
The verify script runs checks on the Pi over SSH, including architecture, installed commands, chartplotter autostart, GPSD startup options, user units, config, and `noaa-navionics status-report`.
