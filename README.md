...
After the reboot, the dock test uses the stricter verify mode that requires the chartplotter launcher log to be fresh for the current boot and requires an `opencpn` process to be running.
