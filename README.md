...
Run install, deployment, GPS setup, provisioning, verification, and dock tests as the normal Pi desktop user, not `root`; SSH targets must use `user@host`, and the scripts use `sudo` only for the specific system changes they need.
